            ...
            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                    ...
                    <textarea id="comment" rows="4"
                              ...
                              placeholder="O que você aprendeu hoje?" name="content" required>{{old('content')}}</textarea>
                </div>
                <div class="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                    ...
                    @error('errors')
                    <div class="flex items-center w-full p-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-700 dark:text-red-400" role="alert">
